export function RenderFeatures() {
    const features = [
        'Themed colors for both Light and Dark mode',
    ...
    return (
        <section className="p-2 self-start flex flex-col gap-4">
            ...
            <ul className="sec-font flex flex-col gap-2 text-(--surface-muted-fg)">
                {features.map(f => {
                    return (
                        <li className="text-lg" key={f}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" className="inline-block m-1 text-(--primary-bg)">
            ...
            <span title="formats we support" className="text-lg flex flex-wrap gap-2 items-center">
