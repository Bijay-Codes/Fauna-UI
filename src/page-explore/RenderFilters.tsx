    ...
    return (
        <>
            ...
            >
                ...
                <div className="absolute p-2 bg-(--surface-bg) border border-(--surface-muted-bg) rounded-lg w-max min-w-30 sm:min-w-40 sm:max-h-80 max-h-60 overflow-y-auto z-30">
                    <div className="flex flex-col gap-1">
                        {category.map(c =>
                            c.subcategories.map(sc => (
                                <div key={sc} className="flex items-center gap-2 
                                hover:bg-(--accent-bg) hover:text-(--accent-fg) hover:-translate-y-0.5
                                transition-all duration-500 ease-in-out rounded px-2">
                                    <input
